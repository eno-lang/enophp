  ...
  foreach($context['instructions'] as $instruction) {
    ...
    if($instruction['type'] == 'NAME') {
      ...
      if(array_key_exists('template', $instruction)) {
        $context['unresolvedInstructions'][] = $instruction;
      }
    ...
    if($instruction['type'] == 'LIST_ITEM') {
      ...
      $last_name_instruction['subinstructions'] = array_merge($last_section_instruction['subinstructions'], $unresolved_idle_instructions);
      $unresolved_idle_instructions = [];
    ...
    if($instruction['type'] == 'CONTINUATION') {
      ...
      $last_continuable_instruction['subinstructions'] = array_merge($last_section_instruction['subinstructions'], $unresolved_idle_instructions);
      $unresolved_idle_instructions = [];
